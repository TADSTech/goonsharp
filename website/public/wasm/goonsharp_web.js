/* @ts-self-types="./goonsharp_web.d.ts" */
...
export class CompileResult {
    ...
    get errors() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.compileresult_errors(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get rust_code() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.compileresult_rust_code(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
 ...
 */
export function compile_goonsharp(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compile_goonsharp(ptr0, len0);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('goonsharp_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
